...
/***/ function(module, exports, __webpack_require__) {
	...
	//依赖的子组件
	var  ComponentHeader=__webpack_require__(168);

	var  ComponentSearch=__webpack_require__(169);

	var  ComponentBanner=__webpack_require__(172);

	var  ComponentList=__webpack_require__(173);

	var  ComponentFooter=__webpack_require__(174);
		...
		render:function(){
			return(
			  React.createElement("div", null, 	
				React.createElement("div", {id: "header-comp"}), 
				React.createElement("div", {id: "search-comp"}), 
				React.createElement("div", {id: "banner-comp"}), 
				React.createElement("div", {id: "list-comp"}), 
				React.createElement("div", {id: "footer-comp"})
			 )
			);
		}
	});
	...
	ReactDOM.render(React.createElement(ComponentHeader, null),document.getElementById("header-comp"));
	ReactDOM.render(React.createElement(ComponentSearch, null),document.getElementById("search-comp"));
	ReactDOM.render(React.createElement(ComponentBanner, null),document.getElementById("banner-comp"));
	ReactDOM.render(React.createElement(ComponentList, null),document.getElementById("list-comp"));
	ReactDOM.render(React.createElement(ComponentFooter, null),document.getElementById("footer-comp"));
		...
		render:function(){
			return(
				React.createElement("header", null, 
					React.createElement("img", {src: "img/header-img.gif"})
				)
			);
		}
	});
			...
			return(
				React.createElement("section", null, 
					React.createElement("div", {className: "search-box"}, 
									React.createElement("img", {src: "img/search-img.gif"}), 
									React.createElement("input", {onChange: this.listener, type: "text", placeholder: "请输入商品名称"})
					)
				)
			);
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ComponentRegister =__webpack_require__(171);
	...
	var ComponentSearchList=__webpack_require__(175);
		...
		dispacher:function(event){
			...
			switch(_title){
				...
				case "3":
				  ...
				  ReactDOM.render(React.createElement(ComponentRegister, null),document.getElementById("list-comp"));
		...
		render:function(){
			...
			return(
				React.createElement("div", {className: "register"}, 
			       React.createElement("div", {className: "username", style: _css.margin}, 
			          React.createElement("label", null, "用户名:"), React.createElement("input", {id: "username", type: "text"})
			       ), 
			       React.createElement("div", {className: "password", style: _css.pass}, 
			          React.createElement("label", null, "密码:"), React.createElement("input", {id: "password", type: "password"})
			       ), 
			       React.createElement("div", {className: "repassword", style: _css.pass}, 
			           React.createElement("label", null, "重复密码:"), React.createElement("input", {id: "repassword", type: "password"})
			       ), 
			       React.createElement("div", {className: "userbtn", style: _css.pass}, 
			           React.createElement("img", {onClick: this.register, style: _css.img, src: "img/regs.png"})
			       )
			    )
			);
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ComponentBanner=React.createClass({displayName: "ComponentBanner",
		...
		render:function(){
			...
			for(var i=0;i<this.state.result.length;i++){
				template.push(React.createElement(ComponentBannerItem, {name: this.state.result[i]}));
			}
	...
	var ComponentBannerItem=React.createClass({displayName: "ComponentBannerItem",
		render:function(){
			...
			return(
				React.createElement("div", {className: "swiper-slide"}, 
				    	React.createElement("img", {className: "swiper-img", src: img})
				)
			);
		}
	});
	...
	var ComponentList=React.createClass({displayName: "ComponentList",
		...
		render:function(){
			...
			this.state.result.map(function(item){
				list.push(React.createElement(ComponentListItem, {name: item}))
			});
			
			return(
				React.createElement("div", {className: "shoplist"}, 
				  list
				)
			);
		}
	});
	var ComponentListItem=React.createClass({displayName: "ComponentListItem",
		render:function(){
			return(
				React.createElement("div", {className: "shopitem"}, 
							React.createElement("div", {className: "itemimg"}, 
								React.createElement("img", {src: this.props.name.goodsListImg})
							), 
							React.createElement("div", {className: "itemdesc"}, 
								React.createElement("div", {className: "goodsName"}, this.props.name.goodsName), 
								React.createElement("div", {className: "goodsPrice"}, "￥", React.createElement("span", null, this.props.name.price)), 
								React.createElement("div", {className: "goodsDiscount"}, this.props.name.discount)
							)
				)
			);
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React=__webpack_require__(1);
	var Tool=__webpack_require__(170);
	/**页脚组件---开始**/
			...
			return(
			  React.createElement("div", null, 	
					React.createElement("footer", null, 
						  ...
						  React.createElement("div", {title: "0", onClick: this.dispacher}, "首页"), 
						  React.createElement("div", {title: "1", onClick: this.dispacher}, "分类"), 
						  React.createElement("div", {title: "2", onClick: this.dispacher}, "购物车"), 
						  React.createElement("div", {title: "3", onClick: this.dispacher}, "我的秀"), 
						  React.createElement("div", {title: "4", onClick: this.dispacher}, "更多")
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React=__webpack_require__(1);
	//列表 ---开始
	var ComponentSearchList=React.createClass({displayName: "ComponentSearchList",
		render:function(){
			console.log("get result is&&&&");
			console.log(this.props.name);
			var list=[];
			this.props.name.map(function(item){
				list.push(React.createElement(ComponentSearchListItem, {name: item}));
			});
			return(
				React.createElement("div", {className: "shoplist"}, 
				   list
	...
	var ComponentSearchListItem=React.createClass({displayName: "ComponentSearchListItem",
		render:function(){
			return(
				React.createElement("div", {className: "shopitem"}, 
							React.createElement("div", {className: "itemimg"}, 
	...
	var Component={
		...
		listener:function(event){
			...
			this.getJson(url,function(data){
				...
				ReactDOM.render(React.createElement(ComponentSearchList, {name: data}),document.getElementById("list-comp"));
			})
